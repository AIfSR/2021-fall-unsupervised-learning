...
class XDisplacementFeatureCreatorTest (unittest.TestCase):
    def get_feature_creator(self):
        ...
        return YDisplacementFeatureCreator()
    ...
    def test_get_features(self):
        ...
        yDisplacementFeatureCreator = YDisplacementFeatureCreator()
        solutionFeatures = Features()
        solutionFeatures.add_feature_val(1)
        # solutionFeatures.add_feature_val(3.0**0.5)

        self.assertEquals(yDisplacementFeatureCreator.get_features(points), solutionFeatures)

    def test_string(self):
        featureCreator = YDisplacementFeatureCreator()
