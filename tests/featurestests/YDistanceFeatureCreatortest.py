...
class YDistanceFeatureCreatorTest (unittest.TestCase):
    def get_feature_creator(self):
        ...
        return YDistanceFeatureCreator()
    ...
    def test_get_features(self):
        ...
        yDistanceFeatureCreator = YDistanceFeatureCreator()
        ...
        self.assertEquals(yDistanceFeatureCreator.get_features(points), solutionFeatures)

    def test_string(self):
        featureCreator = YDistanceFeatureCreator()
